var PageTransitions = (function (a, e) {
   ...
   function i() {
      ...
      function t() {
         a("#page-ajax-loaded").addClass("animated-section-moveToRight closed"),
      ...
      a(document)
         .on("click", ".main-menu, #ajax-page-close-button", function (a) {
   ...
   function s(e, t) {
      ...
      var t,
         ...
         i,
         s,
         m = e.data("animation").toString();
      if (-1 != m.indexOf("-")) {
         var h = m.split("-");
         s = parseInt(h[Math.floor(Math.random() * h.length)]);
      } else s = parseInt(m);
      if (s > 67)
         return alert("Transition.js : Invalid 'data-animation' attribute configuration. Animation number should not be greater than 67"), !1;
      switch (s) {
         case 1:
